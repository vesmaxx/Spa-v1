...
<div class="container-fluid">
	...
	<!-- DataTales Example -->
	<div class="card shadow mb-4" style="padding:50px 0">

  	<div class="container">
  <h2 style="text-align: center;" >Update Staff</h2>
  
  <form style="margin: 0 170px" class="form-horizontal" action="${pageContext.request.contextPath }/admin/update-staffs" enctype="multipart/form-data" method="POST">
  <input type="hidden" class="form-control" value="${staffs.id}" id="" placeholder="Nhập tên dịch vụ" name="id">
    <div class="form-group">
      <label style="margin-left: 20px" class="control-label col-sm-2" >Name:</label>
      <div class="col-sm-10">
        <input required type="text" class="form-control" value="${staffs.name}" id="" placeholder="Nhập tên nhân viên" name="name">
      </div>
    </div>
    <div class="form-group">
					<label style="margin-left: 20px" class="control-label col-sm-2" for="pwd">Gender:</label>

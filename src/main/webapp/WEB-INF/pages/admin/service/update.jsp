...
<div class="container-fluid">
	...
	<!-- DataTales Example -->
	<div margin-left: 50px class="card shadow mb-4" style="padding:50px 0">

  	<div class="container">
  <h2 style="text-align: center;" >Update Service</h2>
  <form style="margin: 0 170px" class="form-horizontal" action="${pageContext.request.contextPath }/admin/service-update2" method="POST" enctype="multipart/form-data">
  <input  type="hidden" class="form-control" id="" value="${service.id}" placeholder="Nhập tên dịch vụ" name="id">
    <div class="form-group">
      <label style="margin-left: 20px" class="control-label col-sm-2" for="email">Name:</label>
      <div class="col-sm-10">
        <input  required type="text" class="form-control" value="${service.name }" id="" placeholder="Nhập tên dịch vụ" name="name">
      </div>
    </div>
    <div class="form-group">
      <label style="margin-left: 20px" class="control-label col-sm-2" for="pwd">Price:</label>
      <div class="col-sm-10">          
        <input required  type="number" class="form-control" value="${service.price }" id="" placeholder="Nhập giá dịch vụ" name="price">
      </div>
    </div>
    <div class="form-group">
      <label style="margin-left: 20px" class="control-label col-sm-2" for="pwd">Image:</label>
      <div class="col-sm-10">          
        <input type="file"  class="form-control" required  id="photo" accept="image/gif, image/jpeg, image/png" name="photo2">
      </div>
    </div>
    <div class="form-group">        
